...
function editProduct(productId) {
  fetch(`http://localhost:8080/admin/product/update/${productId}`, {
    ...
    .then((data) => {
      ...
      document.getElementById("edit-productBrand").value =
      ...
      document.getElementById("edit-cpuCompany").value =
        productDetail.cpuCompany;
      ...
      document.getElementById("edit-maximunSpeed").value =
        productDetail.maximunSpeed;
      document.getElementById("edit-multiplier").value =
        productDetail.multiplier;
      ...
      document.getElementById("edit-vgaFullName").value =
        productDetail.vgaFullName;

      document.getElementById("edit-ramCapacity").value =
      ...
      document.getElementById("edit-screenSize").value =
        productDetail.screenSize;
      ...
      document.getElementById("edit-screenType").value =
        productDetail.screenType;
      ...
      document.getElementById("edit-keyboardType").value =
        productDetail.keyboardType;
      ...
      document.getElementById("edit-powerSupply").value =
      ...
      document.getElementById("edit-batteryType").value =
        productDetail.batteryType;
      ...
      document.getElementById("edit-userManual").value =
        productDetail.userManual;

      document.getElementById("edit-brightness").value =
        productDetail.brightness;
...
async function saveProduct(productId) {
  try {
    ...
    const updatedProduct = {
      ...
      fullNameCardOboard: document.getElementById("edit-fullNameCardOboard")
        .value,
      ...
      displayTechnology: document.getElementById("edit-displayTechnology")
        .value,
      ...
      screenRatio: parseInt(document.getElementById("edit-screenRatio").value),
      communicationPort: document.getElementById("edit-communicationPort")
        .value,
      ...
      accessoriesInTheBox: document.getElementById("edit-accessoriesInTheBox")
        .value,
      ...
      storageInstructions: document.getElementById("edit-storageInstructions")
        .value,
