  ...
  try {
    ...
    const updatedProduct = {
      ...
      minimumCPUspeed: parseFloat(
        document.getElementById("minimumCPUspeed").value
      ),
      ...
      numberOfRemovableSlots: parseInt(
        document.getElementById("numberOfRemovableSlots").value
      ),
      numberOfOnboardRAM: parseInt(
        document.getElementById("numberOfOnboardRAM").value
      ),
      maximumRAMSupport: parseInt(
        document.getElementById("maximumRAMSupport").value
      ),
      hardDriveType: document.getElementById("hardDriveType").value,
      totalSSDHDDSlots: parseInt(
        document.getElementById("totalSSDHDDSlots").value
      ),
      numberOfSSDHDDSlotsRemaining: parseInt(
        document.getElementById("numberOfSSDHDDSlotsRemaining").value
      ),
      maximumHardDriveUpgradeCapacity: parseInt(
        document.getElementById("maximumHardDriveUpgradeCapacity").value
      ),
      ...
      numericKeypad: document.getElementById("numericKeypadTrue").checked
        ? true
        : false,
      ...
      warrantyPeriodMonths: parseInt(
        document.getElementById("warrantyPeriodMonths").value
      ),
